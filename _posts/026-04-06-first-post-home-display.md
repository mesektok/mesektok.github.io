...
파일 이름이 이 규칙을 따라야  
Chirpy가 글 날짜와 URL을 정확히 인식합니다. [web:566]
...
Jekyll이 글로 인식하지 않아서 홈에 나오지 않습니다. [web:566]
...
3. 방금 만든 글이 최상단(가장 위)에 보이는지 확인합니다. [web:447]
...
Chirpy의 인덱스 템플릿을 약간 수정해 “특집 포스트 1개 + 나머지 목록” 구조로 만들 수 있습니다. [web:447]
